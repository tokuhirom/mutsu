...
| [ADR-0036](../docs/adr/0036-element-container-pairs-from-subscripts-and-pairs.md) element container cells | **CLOSED 2026-09-01 — every slice landed.** §1.3 re-measured 12/12; slice 5's 69-row sweep found residuals, none a regression | Nothing. Residuals: `producer-seq-index-read-decontainerizes-the-element-cell` (new) and `promoted-element-cell-does-not-know-its-container-name`. `immutable-lvalues-...` is **no longer blocked on this ADR** — re-measured, no row moved |
...
| [ADR-0040](../docs/adr/0040-array-hash-elements-are-itemized-at-the-store.md) element itemization at the store | **COMPLETE (slice 5, 2026-09-02)**: all 25 §1.3 rows byte-identical to raku, both compensators deleted | residue: `var-on-a-bare-valued-hash-answers-scalar`, `var-on-a-real-element-is-an-opaque-descriptor-not-the-container` |
