...
is $=pod[0].contents.elems, 2, "begin pod stores comment and paragraph children";
...
is $=pod[0].contents[1].contents[0], "plain pod text", "begin pod keeps plain paragraph text";
