...
is (1, 3 ... 10).join(', '), '1, 3, 5, 7, 9', 'arithmetic past endpoint';
is (1, 3, 9 ... 100).join(', '), '1, 3, 9, 27, 81', 'geometric past endpoint';
...
# wrong side
is (1, 2 ... 0).elems, 0, 'wrong side gives empty';
...
is (1, 2 ...^ 0, 'xyzzy', 'plugh').join(', '), 'xyzzy, plugh', 'exclusive with extra RHS';
