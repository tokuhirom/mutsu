...
{
    my %r = get_out('use Test; plan 1; throws-like { die "boom" }, Exception;');
    ok %r<out>.contains("# Subtest: did we throws-like Exception?"), 'throws-like emits default description in subtest header';
    ok %r<out>.contains("ok 1 - did we throws-like Exception?"), 'throws-like emits default description in summary line';
}
