...
Generated 2026-09-15 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **45.6%** (511/1121) |
| file parity | 57.5% (2163/3765) |
| assertion parity | 67.3% |
...
| `App::ModuleSnap` | 0.0.14 | partial | 1/3 |
...
| `Code::Coverable` | 0.0.13 | red | 0/1 |
| `Code::Coverage` | 0.0.8 | red | 0/1 |
...
| `EBNF::Grammar` | 0.1.6 | blocked_load | — |
...
| `FunctionalParsers` | 0.1.10 | blocked_load | — |
...
| `HTML::Parser::XML` | 0.1.3 | blocked_load | — |
...
| `License::SPDX` | 3.28.0 | partial | 1/2 |
...
| `Math::Nearest` | 0.0.7 | partial | 2/5 |
| `Math::NumberTheory` | 0.1.4 | partial | 11/19 |
...
| `Pray` | 0.2 | green | 1/1 |
| `Prettier::Table` | 1.1.3 | partial | 5/13 |
...
| `Version::Repology` | 0.0.5 | partial | 4/7 |
...
| `Web::Scraper` | 0.1.4 | blocked_load | — |
