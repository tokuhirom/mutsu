...
| metric | value |
|---|---|
| **dist parity** (published headline) | **49.6%** (570/1149) |
| file parity | 58.6% (2281/3890) |
...
| `Acme::Insult::Lala` | 0.0.7 | green | 2/2 |
...
| `ANTLR4::Grammar` | 0.6.3 | partial | 1/13 |
...
| `App::IRC::Log` | 0.0.54 | no_baseline | — |
...
| `are` | 0.0.1 | red | 0/1 |
| `Arithmetic::PaperAndPencil` | 0.0.1 | partial | 3/5 |
...
| `Audio::Hydrogen` | 0.0.7 | partial | 1/4 |
...
| `Crypt::LibScrypt` | 0.0.9 | partial | 2/4 |
...
| `Data::Generators` | 0.1.11 | partial | 2/9 |
...
| `Data::Transformers` | 0.0.2 | partial | 2/5 |
...
| `Date::Calendar::Bahai` | 0.1.0 | green | 3/3 |
| `Date::Calendar::CopticEthiopic` | 0.1.1 | green | 3/3 |
| `Date::Calendar::FrenchRevolutionary` | 0.1.0 | green | 3/3 |
| `Date::Calendar::Gregorian` | 0.1.0 | partial | 2/3 |
| `Date::Calendar::Hebrew` | 0.1.0 | blocked_load | — |
| `Date::Calendar::Hijri` | 0.1.0 | blocked_load | — |
| `Date::Calendar::Julian` | 0.1.0 | blocked_load | — |
| `Date::Calendar::MayaAztec` | 0.1.0 | green | 4/4 |
| `Date::Calendar::Persian` | 0.1.0 | partial | 2/3 |
| `Date::Calendar::Strftime` | 0.1.1 | partial | 3/4 |
...
| `Format::Lisp` | 0.0.3 | partial | 30/32 |
...
| `Git::File::History` | 0.0.7 | green | 2/2 |
| `Git::Files` | 0.0.9 | green | 1/1 |
...
| `Grammar::Common` | 0.3.2 | partial | 5/6 |
...
| `highlighter` | 0.0.23 | partial | 1/5 |
...
| `IRC::Client::Plugin::Rakkable` | 0.0.3 | no_baseline | — |
...
| `Math::ConvergenceMethods` | 0.6.0 | green | 5/5 |
...
| `Math::Nearest` | 0.0.7 | partial | 3/5 |
...
| `Pod::To::HTML` | v0.8.1 | partial | 4/15 |
...
| `Rakuast::RakuDoc::Render` | 1.1.1 | blocked_dep | — |
| `RakuAST::Utils` | 0.0.4 | red | 0/1 |
| `RakuConfig` | 0.8.2 | blocked_load | — |
| `Rakudo-Type-Introspection` | 0.0.3 | blocked_load | — |
| `Rakudo::Cache` | 0.0.4 | green | 1/1 |
...
| `SBOM::CycloneDX` | 0.0.18 | blocked_load | — |
| `SBOM::Raku` | 0.0.14 | no_baseline | — |
...
| `Terminal::UI` | 0.1.14 | blocked_load | — |
...
| `Time::gmtime` | 0.0.8 | partial | 2/3 |
| `Time::localtime` | 0.0.6 | partial | 2/3 |
...
| `WhereList` | 1.001002 | partial | 1/2 |
