...
Generated 2026-09-19 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **53.4%** (628/1176) |
| file parity | 62.3% (2496/4005) |
| assertion parity | 69.4% |
...
| `Air::Plugin::Donate` | 0.0.1 | red | 0/1 |
| `Air::Plugin::Hilite` | 0.0.10 | green | 1/1 |
...
| `Cro::RPC::JSON` | 0.1.6 | no_baseline | — |
...
| `Crypt::LibGcrypt` | 1.0.11 | partial | 5/9 |
...
| `Data::Generators` | 0.1.11 | partial | 4/9 |
...
| `Data::Reshapers` | 0.3.8 | partial | 4/15 |
...
| `Ecosystem::Cache` | 0.0.6 | no_baseline | — |
...
| `Math::Fitting` | 0.0.5 | partial | 2/4 |
...
| `Math::NumberTheory` | 0.1.4 | partial | 14/19 |
...
| `ML::SparseMatrixRecommender` | 0.0.4 | partial | 1/5 |
...
| `P5getnetbyname` | 0.0.9 | green | 2/2 |
| `P5getpriority` | 0.0.8 | partial | 1/2 |
| `P5getprotobyname` | 0.0.7 | green | 2/2 |
| `P5getpwnam` | 0.0.11 | green | 2/2 |
| `P5getservbyname` | 0.0.8 | green | 2/2 |
...
| `Protocol::Postgres` | 0.0.13 | red | 0/2 |
...
| `Range::SetOps` | 0.0.4 | partial | 2/5 |
...
| `Template::Jinja2` | 0.3.0 | partial | 18/24 |
