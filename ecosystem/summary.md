...
Generated 2026-09-23 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **60.2%** (717/1191) |
| file parity | 69.9% (2750/3936) |
| assertion parity | 77.6% |
...
| `as-cli-arguments` | 0.0.10 | green | 2/2 |
...
| `Date::Calendar::Hebrew` | 0.1.0 | partial | 2/3 |
...
| `HTML::Parser::XML` | 0.1.3 | green | 8/8 |
...
| `Intl::CLDR` | 0.7.6 | skipped | — |
| `Intl::Format::DateTime` | 0.3.0 | no_baseline | — |
| `Intl::Format::List` | 0.6.0+ | skipped | — |
...
| `Life::Mathematics` | 0.0.1 | green | 1/1 |
...
| `List::MoreUtils` | 0.0.10 | partial | 27/60 |
| `List::Operator::DoublePlus` | 0.1.0 | blocked_load | — |
| `List::SomeUtils` | 0.0.8 | blocked_load | — |
| `List::Util` | 0.0.10 | partial | 12/14 |
| `List::UtilsBy` | 0.0.8 | partial | 9/15 |
...
| `P5getnetbyname` | 0.0.10 | green | 2/2 |
...
| `Rakuast::RakuDoc::Render` | 1.1.3 | blocked_dep | — |
...
| `Scalar::Util` | 0.0.10 | partial | 7/9 |
| `SCGI` | 2.6 | green | 1/1 |
...
| `Text::MathematicalCase` | 0.0.10 | green | 1/1 |
