...
Generated 2026-09-16 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **45.7%** (517/1131) |
| file parity | 57.4% (2181/3801) |
...
| `Acme::Text::UpsideDown` | 0.0.9 | green | 1/1 |
...
| `App::Rak::Complete` | 0.0.13 | skipped | — |
| `App::Rak::Markdown` | 0.0.5 | green | 1/1 |
| `App::Raku::Log` | 0.0.37 | skipped | — |
...
| `FunctionalParsers` | 0.1.10 | partial | 7/18 |
...
| `IRC::Client::Plugin::Rakkable` | 0.0.3 | skipped | — |
| `IRC::Log` | 0.0.26 | green | 1/1 |
| `IRC::Log::Colabti` | 0.0.53 | red | 0/2 |
