...
Generated 2026-09-25 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **63.4%** (765/1207) |
| file parity | 73.0% (3029/4151) |
| assertion parity | 83.9% |
...
| `AI::Gator` | 0.0.14 | green | 2/2 |
| `Air` | 0.1.32 | partial | 1/2 |
...
| `DSL::English::FoodPreparationWorkflows` | 0.1.0 | no_baseline | — |
...
| `DSL::Entity::AddressBook` | 0.1.0 | no_baseline | — |
...
| `Humming-Bird` | 4.1.0 | partial | 8/16 |
...
| `List::Util` | 0.0.10 | partial | 13/14 |
...
| `NotoFonts-OT` | 0.3.3 | no_baseline | — |
...
| `ORM::Factory` | 0.9.1 | partial | 20/25 |
...
| `Terminal::UI` | 0.1.14 | partial | 3/10 |
