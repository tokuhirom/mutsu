...
Generated 2026-09-14 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **44.6%** (494/1107) |
| file parity | 55.9% (2088/3734) |
| assertion parity | 67.1% |
...
| `AlgorithmsIT` | 0.0.4 | partial | 5/6 |
...
| `App::Moneymoor` | 0.4.2 | partial | 18/30 |
...
| `are` | 0.0.1 | red | 0/1 |
| `Arithmetic::PaperAndPencil` | 0.0.1 | partial | 2/5 |
...
| `Array::Sorted::Map` | 0.0.4 | green | 1/1 |
| `Array::Sorted::Util` | 0.0.11 | green | 5/5 |
...
| `CoreHackers::Q` | 1.003000 | no_baseline | — |
...
| `Crypt::LibGcrypt` | 1.0.11 | partial | 6/9 |
...
| `Data::Reshapers` | 0.3.8 | partial | 3/15 |
...
| `Date::Discordian` | 0.0.3 | green | 1/1 |
...
| `dosh` | .0.0 | partial | 1/2 |
| `DOSH::CLI` | 7.0.0 | partial | 1/2 |
...
| `Hash::MutableKeys` | 0.0.1 | red | 0/1 |
...
| `Lingua::EN::Numbers` | 2.8.3 | green | 9/9 |
...
| `LLM::Character` | 0.2.3 | partial | 11/14 |
...
| `LLM::Prompts` | 0.2.15 | partial | 2/4 |
...
| `Markdown::Lex` | 0.2.0 | partial | 1/5 |
...
| `Math::Constants` | 0.2.2 | green | 1/1 |
...
| `Math::NumberTheory` | 0.1.4 | partial | 10/19 |
...
| `MetamodelX::Dataclass` | 0.0.2 | partial | 1/2 |
...
| `ML::FindTextualAnswer` | 0.2.8 | red | 0/1 |
...
| `NotoFonts-OT` | 0.3.2 | no_baseline | — |
...
| `Rakuast::RakuDoc::Render` | 1.1.0 | blocked_dep | — |
...
| `Slangify::Tutorial` | 0.0.1 | green | 1/1 |
...
| `Syndicate` | 0.0.6 | partial | 13/32 |
| `Syntax::Highlighters` | 0.1.5 | partial | 1/2 |
...
| `Time::gmtime` | 0.0.8 | green | 3/3 |
| `Time::localtime` | 0.0.6 | green | 3/3 |
