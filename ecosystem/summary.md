...
Generated 2026-09-20 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **55.1%** (645/1171) |
| file parity | 64.1% (2482/3874) |
| assertion parity | 69.9% |
...
| `Air::Plugin::Donate` | 0.0.1 | green | 1/1 |
...
| `CellularAutomata` | 0.0.1 | skipped | — |
...
| `CoreHackers::NfaChainsaw` | 0.0.1.1 | skipped | — |
...
| `CWT-Repository-Hash` | v0.0.3 | skipped | — |
| `Dan` | 0.0.3 | green | 4/4 |
...
| `Data::Reshapers` | 0.3.8 | partial | 5/15 |
| `Data::StaticTable` | 0.1.1 | green | 5/5 |
| `Data::Summarizers` | 0.2.6 | partial | 1/6 |
...
| `Geo::Coordinates::UTM` | 0.9.0 | partial | 1/3 |
...
| `Hash::Consistent` | 0.0.4 | green | 1/1 |
| `Hash::int` | 0.0.7 | red | 0/1 |
| `Hash::LRU` | 0.0.8 | partial | 1/2 |
| `Hash::MutableKeys` | 0.0.1 | red | 0/1 |
| `Hash::Ordered` | 0.0.9 | green | 1/1 |
...
| `HTML::Functional` | 0.0.8 | partial | 1/2 |
...
| `Math::Matrix` | 0.4.2 | partial | 4/11 |
...
| `NativeHelpers::Array` | 0.0.6 | partial | 2/3 |
...
| `Notcurses::Native` | 0.6.6 | blocked_load | — |
...
| `Statistics::Distributions` | 0.1.8 | green | 3/3 |
