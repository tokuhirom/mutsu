...
Generated 2026-09-18 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **52.1%** (603/1158) |
| file parity | 60.5% (2382/3935) |
| assertion parity | 68.4% |
...
| `Date::Calendar::Gregorian` | 0.1.0 | green | 3/3 |
...
| `Net::Ethereum` | 0.0.185 | partial | 12/14 |
...
| `Rakuast::RakuDoc::Render` | 1.1.2 | blocked_dep | — |
