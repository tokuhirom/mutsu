...
Generated 2026-09-21 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **57.2%** (674/1179) |
| file parity | 65.8% (2560/3892) |
| assertion parity | 70.7% |
...
| `Date::Easter` | 0.0.5 | green | 2/2 |
| `Date::Event` | 0.0.12 | partial | 4/5 |
...
| `DateTime::Monotonic` | 0.1.0 | green | 1/1 |
...
| `Grammar::Modelica` | 0.1.3 | blocked_load | — |
...
| `Holidays::Miscellaneous` | 0.0.1 | green | 7/7 |
...
| `Lumberjack::Application` | 0.0.11 | green | 3/3 |
...
| `raku-RandomColor` | v0.12 | green | 1/1 |
...
| `RakuDoc::Load` | 0.0.2 | partial | 1/2 |
...
| `Range::SetOps` | 0.0.5 | partial | 2/5 |
...
| `Template::Jinja2` | 0.3.0 | partial | 22/24 |
...
| `Terminal::WCWidth` | 0.1.5 | green | 1/1 |
...
| `xxirakup6-RandomColor` | v0.11 | green | 1/1 |
