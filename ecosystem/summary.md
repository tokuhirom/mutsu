...
Generated 2026-09-22 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **58.8%** (699/1189) |
| file parity | 67.3% (2642/3928) |
| assertion parity | 76.2% |
...
| `Chemistry::Stoichiometry` | 0.1.10 | partial | 2/4 |
...
| `Data::Dump::Tree` | 2.9.4 | partial | 2/16 |
...
| `Implementation::Loader` | 0.0.10 | green | 3/3 |
...
| `Math::Matrix` | 0.4.2 | partial | 6/11 |
