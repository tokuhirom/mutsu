...
Generated 2026-09-24 from `ecosystem/dists/`. Method and metric
definitions: [docs/ecosystem-parity.md](../docs/ecosystem-parity.md).

| metric | value |
|---|---|
| **dist parity** (published headline) | **61.2%** (734/1199) |
| file parity | 71.7% (2918/4071) |
| assertion parity | 83.3% |
...
| `ANTLR4::Grammar` | 0.6.3 | partial | 4/13 |
...
| `App::Moneymoor` | 0.4.2 | partial | 20/30 |
...
| `Date::Calendar::Julian` | 0.1.0 | partial | 2/3 |
...
| `Notcurses::Native` | 0.6.6 | green | 9/9 |
...
| `Sparky::Minimal` | 0.0.3 | green | 1/1 |
| `Sparrow6` | 0.0.96 | green | 4/4 |
...
| `Template::Nest::XS` | 0.1.10 | no_baseline | — |
