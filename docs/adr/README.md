...
| [0117](0117-str-methods-and-nqp-ops-share-one-routine.md) | `Str` methods, `nqp::` string ops, VM string opcodes and TRIR string ops share one routine per primitive (`src/builtins/str_prim/`), grapheme-indexed; enforced by `make check-str-prims` | Accepted (implemented) |
