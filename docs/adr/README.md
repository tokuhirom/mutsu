...
| [0106](0106-raku-level-profiler.md) | The Raku-level profiler — sampled time over the static ip→line table, exact counts at the chokepoints that already exist | Proposed (design complete; implementation not started) |
