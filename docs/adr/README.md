...
| [0035](0035-method-calls-observe-caller-frames.md) | Caller-frame observation from method bodies — chain-aware dynamics enumeration, plus `uses_callframe`-gated frame pushing at the two compiled-method chokepoints | Proposed (design complete; implementation not started) |
