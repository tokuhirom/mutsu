...
| [0122](0122-repl-compiler-object-and-eval-contexts.md) | `nqp::getcomp("Raku")` is a Raku-level compiler object, and a REPL context is a captured unit environment plus its lexical routines | Proposed (implemented) |
