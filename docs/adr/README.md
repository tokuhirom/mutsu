...
| [0030](0030-native-array-decode-cache-interior-mutability.md) | The native `array[T]` decode cache is a read-path cache, and needs field-level interior mutability — not `gc_contents_mut` | Proposed (design complete; implementation not started) |
