...
| [0029](0029-exception-class-role-membership.md) | Built-in `X::` exception ancestry is role membership, not a single parent — register it through the existing composed-role path | Proposed (Slices 1-3 implemented; Slice 4 deferred — see "Implementation status") |
