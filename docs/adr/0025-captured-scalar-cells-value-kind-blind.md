...
- **Merge-order / authoritative widening**: cannot satisfy hijack
  ...
  liveness direction). **Superseded on this point by ADR-0055 (2026-08-20):**
  ...
  closure-wins merge. ADR-0055 argues closure-wins + cells satisfies both
  ...
  ADR-0055 §1.2). Nothing else in this ADR is superseded.
