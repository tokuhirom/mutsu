...
pub(in crate::runtime) use state_supplier::{
    ...
    register_supplier_share_output, register_supplier_start_tap, register_supplier_tap,
    register_supplier_transform_tap, register_supplier_unique_transform_tap,
    register_supplier_whenever_quit_callback, register_supplier_words_transform_tap,
    register_supplier_zip_latest_tap, register_supplier_zip_tap, register_zip_latest_state,
    register_zip_state, set_supplier_serialize_group, set_supplier_serialize_group_if_absent,
    ...
    pub(crate) fn supply_chunk_to_bytes(&self, chunk: &Value, encoding_name: &str) -> Vec<u8> {
        ...
        match chunk.view() {
            ValueView::Instance {
                ...
                crate::runtime::utils::is_buf_or_blob_class(&cn) && cn != "utf16"
            } =>
            {
