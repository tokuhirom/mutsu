...
- **§2 Phase B** は層3a（GC）・層3b（NaN-boxing）完了 — 次の大型スライスは層4 JIT（ADR-0004）。
...
| **C. JIT** | 独自メリット（**いまここ** — 層3b ゲート達成で着手条件成立） | §5 Lever 4 |
...
- [ ] **層4 JIT（Cranelift・= §5 Lever 4）**: 着手条件（層3b ゲート）達成。方式・フェーズ
      （J1 骨組み → J2 Tier A 網羅 → J3 呼び出し規約/IC → J4 Tier B インライン → J5 既定 on）=
...
- [ ] **Lever 4: JIT（Cranelift）= ADR-0001 層4（GC の後）/ Lever 5: 型制約チェックの tight-loop 省略**。
      ...
      着手条件 = 層3b（Lever 2）のゲート達成 — **達成済み（2026-07-12）・着手可能**。
