...
## 2. ★ Phase B: GC → NaN-boxing → JIT（層3a・層3b 完了／層4 JIT は J1〜J5 完了・既定 on — 残 J4d）
...
- [ ] **④ エラーメッセージ品質 2 本**: `error-reporting.t`（mutsu 4/33・raku 33/33）・
      `weird-errors.t`。§6 の「エラーメッセージ品質向上」を roast の合否で駆動できる。
