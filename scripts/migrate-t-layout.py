...
SUBRULES: dict[str, list[tuple[str, str]]] = {
    ...
    "routines": [
        ("signature", r"param|signature|slurpy|destructure|subsig|^where-|^is-default|^is-rw-traits|^invocant-marker|^optional-|^required-|^default-arg|^named-arg|^too-(?:many|few)-positionals|^nested-any-type-constraint"),
